...
add_action( 'customize_register', 'pagoda_press_customizer_premium_features' );

function pagoda_press_customizer_premium_features( $wp_customize ) {
    ...
    $premium_features = '<div class="premium-info"><h2>' . esc_html__( 'Premium Version', 'pagoda-press' ) . ': </h2>
	...
	<a class="button button-primary" href="' . esc_url( 'https://graphthemes.com/pagoda-press/' ) . '" target="_blank">' . esc_html__( 'Upgrade to Pro', 'pagoda-press' ) . '</a></div>';

	$wp_customize->add_control( new Pagoda_Press_Custom_Text( $wp_customize ,'premium_features',array(
