...
add_action( 'wp_enqueue_scripts', 'pagoda_press_google_fonts_scripts' );
function pagoda_press_google_fonts_scripts() {
    $args = pagoda_press_used_google_fonts();
    wp_enqueue_style( 'google-fonts', pagoda_press_fonts_url( $args ), array(), null );
}