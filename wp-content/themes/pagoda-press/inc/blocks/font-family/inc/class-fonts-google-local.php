...
final class Pagoda_Press_Google_Local {
	 ...
	 * @return Pagoda_Press_Google_Local
	 */
	...
	public function get_root_path() {
		...
		// Return the path.
		return apply_filters( 'pagoda_press_googlefonts_root_path', $path );
	}
	...
	public function get_root_url() {
		...
		return apply_filters( 'pagoda_press_googlefonts_root_url', untrailingslashit( esc_url_raw( $url ) ) . '/webfonts' );
	}
