...
add_action( 'customize_register', 'pagoda_press_register_post_detail_customization_section' );
function pagoda_press_register_post_detail_customization_section( $wp_customize ) {

	$wp_customize->add_section( 'pagoda_press_post_detail_customization_section', array(
	    'title'	=> esc_html__( 'Post Detail', 'pagoda-press' ),
	    'priority'	=> 23
	) );
