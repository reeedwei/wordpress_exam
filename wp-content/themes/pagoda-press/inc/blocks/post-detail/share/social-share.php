...
add_action( 'customize_register', 'pagoda_press_post_detail_social_share' );
function pagoda_press_post_detail_social_share( $wp_customize ) {

	$wp_customize->add_setting( 'post_detail_hide_show_social_share', array(
        'sanitize_callback'     =>  'pagoda_press_sanitize_checkbox',
        'default'               =>  pagoda_press_get_default_post_detail_social_share()
    ) );
...
add_action( 'customize_register', 'pagoda_press_post_detail_social_share_options' );
function pagoda_press_post_detail_social_share_options( $wp_customize ) {

    $wp_customize->add_setting( 'post_detail_social_share_options', array(
        'sanitize_callback' => 'pagoda_press_sanitize_array',
        'default'     => pagoda_press_get_default_post_detail_social_share_options()
    ) );
    ...
    $wp_customize->add_control( new Graphthemes_Multi_Check_Control( $wp_customize, 'post_detail_social_share_options', array(
        ...
        'active_callback' => function() {
            return get_theme_mod( 'post_detail_hide_show_social_share', pagoda_press_get_default_post_detail_social_share() );
        }
    ) ) );
