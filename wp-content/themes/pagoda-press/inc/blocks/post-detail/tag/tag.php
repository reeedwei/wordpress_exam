...
add_action( 'customize_register', 'pagoda_press_post_detail_tag' );
function pagoda_press_post_detail_tag( $wp_customize ) {

	$wp_customize->add_setting( 'post_detail_hide_show_tag', array(
        'sanitize_callback'     =>  'pagoda_press_sanitize_checkbox',
        'default'               =>  pagoda_press_get_default_post_detail_tag()
    ) );
