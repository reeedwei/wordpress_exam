...
add_action( 'customize_register', 'pagoda_press_post_snippet_featured_image' );
function pagoda_press_post_snippet_featured_image( $wp_customize ) {

	$wp_customize->add_setting( 'post_snippet_hide_show_featured_image', array(
        'sanitize_callback'     =>  'pagoda_press_sanitize_checkbox',
        'default'               =>  pagoda_press_get_default_post_snippet_featured_image()
    ) );
...
add_action( 'customize_register', 'pagoda_press_post_snippet_featured_image_size' );
function pagoda_press_post_snippet_featured_image_size( $wp_customize ) {

    $wp_customize->add_setting( 'post_snippet_featured_image_size', array(
        'default'     => pagoda_press_get_default_post_snippet_featured_image_size(),
    ...
    $wp_customize->add_control( 'post_snippet_featured_image_size', array(
        ...
        'active_callback' => function(){
            return get_theme_mod( 'post_snippet_hide_show_featured_image', pagoda_press_get_default_post_snippet_featured_image() );
        },
        'choices'     => array(
