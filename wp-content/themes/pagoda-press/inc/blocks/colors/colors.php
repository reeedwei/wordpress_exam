...
add_action( 'customize_register', 'pagoda_press_color_section' );
function pagoda_press_color_section( $wp_customize )
{
    $wp_customize->get_section( 'colors' )->title = esc_html__( "Color Options", 'pagoda-press' );
