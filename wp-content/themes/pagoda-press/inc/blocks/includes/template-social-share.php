<script type="text/javascript">
	var fb = '<?php echo esc_html__( "Facebook", "pagoda-press" ); ?>';
	var twitter = '<?php echo esc_html__( "Twitter", "pagoda-press" ); ?>';
	var pinterest = '<?php echo esc_html__( "Pinterest", "pagoda-press" ); ?>';
	var linkedin = '<?php echo esc_html__( "Linkedin", "pagoda-press" ); ?>';
</script>
...
<ul class="list-inline">
	...
	<li><?php esc_html_e( "Share", 'pagoda-press' ); ?>:</li>
