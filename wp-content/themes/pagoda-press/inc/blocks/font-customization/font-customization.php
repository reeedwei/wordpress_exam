...
add_action( 'customize_register', 'pagoda_press_register_font_customization_section' );
function pagoda_press_register_font_customization_section( $wp_customize ) {

	$wp_customize->add_section( 'pagoda_press_font_customization_section', array(
	    'title'	=> esc_html__( 'Font Options', 'pagoda-press' ),
	    'priority'	=> 20
	) );
